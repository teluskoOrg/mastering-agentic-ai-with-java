...
public class DataInitializer
{
    ...
    public void initData()
    {
       ...
       // TextReader textReader = new TextReader(new ClassPathResource("Courses.txt"));
        ...
        textReader.getCustomMetadata().put("source", "Courses.txt");
        textReader.getCustomMetadata().put("type", "course-catalog");
...
//        docs.forEach(d-> System.out.println("Document chunk: "+d.getMetadata()));
//        System.out.println("Docs added to vector store: "+docs.size());
