    ...
    public String getAnswerWithRagLLM(@RequestParam String query)
    {
        return chatClient
                ...
                .advisors(QuestionAnswerAdvisor.builder(vectorStore)
                        //RetrievalAugmentationAdvisor --> Modern RAG
...
//        System.out.println();
    ...
    @GetMapping("/modern-rag")
    public String modernRag(@RequestParam String query)
    {
        System.out.println("User Query OG : "+ query);
        ...
        RetrievalAugmentationAdvisor ragAdvisor = RetrievalAugmentationAdvisor
                ...
                .queryAugmenter(ContextualQueryAugmenter.builder()
                                // allow the LLM to answer normally if no doc is found in vector db
                                .allowEmptyContext(true)
                                .build())
                .build();


        ChatClient modernChatClient =
                ChatClient.builder(chatModel)
                        .defaultSystem(
                                """
                                        You are Telusko's course advisor.
                                        Use the provided course cataog context.
                                        Recommend cour name, price duration and level.
                                        """
                        )
                        .defaultAdvisors(ragAdvisor)
                        .build();
       String response= modernChatClient.prompt(query).call().content();
